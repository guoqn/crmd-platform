...
<div class="panel panel-default" ng-controller="relSpecAttrCtrlZ">
    <div class="panel-heading">
        <i class="mark"></i><span class="title">关系规格属性</span>
    </div>
    <div class="panel-body">
        <div class="btn-group relSpecAttrZ-btgroup">
        ...
        <table class="table table-striped" bs-table-control="relSpecAttrZControl">
            <thead>
            <tr>
                ...
                <%--<th data-field="operation" data-formatter="relSpecAttrFormatter.operation">操作</th>--%>
            </tr>
            </thead>
            <tbody>
    ...
    <!-- 模态框 -->
    <div class="modal fade relSpecAttrZModal" tabindex="-1" role="dialog">
                    ...
                    <form class="form-horizontal">
                        ...
                        <ul class="nav nav-tabs" role="tabList">
                            <li role="presentation" class="active">
                                <a href="javascript:;" data-target=".relSpecAttrZBase"
                                   aria-controls="relSpecAttrZBase"
                                   role="tab"
                                   data-toggle="tab"><i class="mark"></i>基本信息</a></li>
                            <li role="presentation" class="">
                                <a href="javascript:;" data-target=".relSpecAttrZComm"
                                   aria-controls="relSpecAttrZComm"
                                   role="tab"
                                   data-toggle="tab"><i class="mark"></i>公共信息</a></li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane relSpecAttrZBase active">
                            ...
                            <div role="tabpanel" class="tab-pane relSpecAttrZComm">

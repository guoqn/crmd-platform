...
@Component("sysWorkItemAttachActionFilter")
public class SysWorkItemAttachActionFilter extends AbstractDaActionFilter {
    ...
    public void beforeAction(DaActionContext context, Object entity, ActionType actionType) {
        if (entity instanceof SysWorkItemAttach) {
            SysWorkItemAttach entt = (SysWorkItemAttach) entity;
    ...
    protected RetVo logHistory(DaActionContext context, Object entity, ActionType actionType) {
        ...
        if (orignEntity instanceof SysWorkItemAttach) {
            ((SysWorkItemAttach) orignEntity).setRecUpdateDate(Timestamp.valueOf(DateUtils
                .getCurDate()));
            ((SysWorkItemAttach) orignEntity).setDtimestamp(DateUtils.getNowDate().getTime());
        }

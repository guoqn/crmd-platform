...
@ShardingBean
@Table(name = "DYNAMIC_PART_WIN_REL")
public class DynamicPartWinRel extends AbstractCrmDomBaseEntityImpl<Long> {
	...
	public DynamicPartWinRel() {
		super();
	}

	public DynamicPartWinRel(boolean genId) {
		if (genId) {
			setId(genEnttId());
		}
	}

	public static IDynamicPartWinRelRepository repository() {
		return (IDynamicPartWinRelRepository) RepositoryRegister.getInstance().getRepository(DynamicPartWinRel.class);
	}

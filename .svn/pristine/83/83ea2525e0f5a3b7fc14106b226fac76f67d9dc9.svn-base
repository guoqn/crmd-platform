...
import com.ffcs.crmd.platform.mq.impl.ProducerDisOrderlyDefined;
import com.ffcs.crmd.platform.mq.producer.api.IProducer;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
        "classpath*:conf/mq/spring/applicationContext-mq-producer-disorderly-userdefined.xml" })
public class TestProducerDisOrderlyDefined {
    
    @Resource(name = "ctgMqDisOrderlyProducer")
    private ProducerDisOrderlyDefined disorderlyProducer;

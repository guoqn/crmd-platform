 ...
 */
public class ClientInterfFilterManager {
    ...
    private static class ClientInterfFilterManagerHolder {
        static ClientInterfFilterManager INSTANCE = new ClientInterfFilterManager();
    }

    private ClientInterfFilterManager() {

    }

    public static ClientInterfFilterManager getInstance() {
        return ClientInterfFilterManagerHolder.INSTANCE;
    }

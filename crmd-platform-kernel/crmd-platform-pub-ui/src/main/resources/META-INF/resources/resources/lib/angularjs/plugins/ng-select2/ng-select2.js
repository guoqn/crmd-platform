...
(function(angular) {
	...
	function select2Ctrl() {

	}

	function select2Directive(select2Query) {
		return {
			restrict: 'A',
			scope: {
				config: '=',
	...
	////Angular Code////
	var app = angular.module("ngSelect2", []);
	app.controller("select2Ctrl", select2Ctrl);
	app.directive("select2", select2Directive);
	app.factory("select2Query", select2QueryFactory);
})(angular);
package com.ffcs.crmd.platform.base.utils.crypt;
...
public class DESEncryptUtil
{
    public static void main(String[] args) throws Exception
    {
        ...
        String keyFilePath = "/Users/linzhiqiang/Workspaces/idea-crm/crmd-platform/crmd-platform-base/src/main/resources/key.k";
        DESEncryptUtil.test(keyFilePath, null, operatorType);
        
        /** 加密 */
        operatorType = "encrypt";
        String sourceFilePath = "/Users/linzhiqiang/Workspaces/idea-crm/crmd-platform/crmd-platform-base/src/main/resources/castor.properties";
        DESEncryptUtil.test(keyFilePath, sourceFilePath, operatorType);
        
        /** 解密 */
        operatorType = "decrypt";
        sourceFilePath = "/Users/linzhiqiang/Workspaces/idea-crm/crmd-platform/crmd-platform-base/src/main/resources/en_castor.properties";
        DESEncryptUtil.test(keyFilePath, sourceFilePath, operatorType);
    }
    /**
     * <ul>
            ...
            String operatorType) throws Exception
    {
        ...
        else if (operatorType.equalsIgnoreCase("encrypt"))
        {
            ...
            file = new File(file.getParent() + File.separator + "en_" + file.getName());
        ...
        else if (operatorType.equalsIgnoreCase("decrypt"))
        {
            ...
            raw.close();
            byte[] orgData = bout.toByteArray();
            file = new File(file.getParent() + File.separator +"rs_" + file.getName());

 ...
 * @author FFCS-CAIWL
 */
public class SysTableDTO extends DomBaseDTO {
    ...
    private List<SysColumnDTO> sysColumnDTOList;

    public List<SysColumnDTO> getSysColumnDTOList() {
        return sysColumnDTOList;
    }

    public void setSysColumnDTOList(List<SysColumnDTO> sysColumnDTOList) {
        this.sysColumnDTOList = sysColumnDTOList;
    }

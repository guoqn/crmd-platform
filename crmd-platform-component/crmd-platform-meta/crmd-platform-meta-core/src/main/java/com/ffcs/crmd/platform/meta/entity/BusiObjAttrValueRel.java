...
import com.ffcs.crmd.platform.meta.repository.IBusiObjAttrValueRelRepository;
...
@Table(name = "BUSI_OBJ_ATTR_VALUE_REL")
public class BusiObjAttrValueRel extends AbstractCrmDomBaseEntityImpl<Long> {

    /**
     * 属性值关系ID
     */
    @Id
    @Column(name = "BUSI_OBJ_ATTR_VALUE_REL_ID")
    ...
    public Long getId() {
        return busiObjAttrValueRelId;
    }

    public void setId(Long id) {
        this.busiObjAttrValueRelId = id;
    }

    public BusiObjAttrValueRel() {
        super();
    }

    public BusiObjAttrValueRel(boolean genId) {
        if (genId) {
            setId(genEnttId());
        }
    }

    public static IBusiObjAttrValueRelRepository repository() {
        return (IBusiObjAttrValueRelRepository) RepositoryRegister.getInstance()
            .getRepository(BusiObjAttrValueRel.class);
    }

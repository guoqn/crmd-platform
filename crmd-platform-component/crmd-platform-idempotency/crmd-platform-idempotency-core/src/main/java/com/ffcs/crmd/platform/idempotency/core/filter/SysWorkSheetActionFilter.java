...
@Component("sysWorkSheetActionFilter")
public class SysWorkSheetActionFilter extends AbstractDaActionFilter {
    ...
    public void beforeAction(DaActionContext context, Object entity, ActionType actionType) {
        if (entity instanceof SysWorkSheet) {
            SysWorkSheet entt = (SysWorkSheet) entity;
    ...
    protected RetVo logHistory(DaActionContext context, Object entity, ActionType actionType) {
        ...
        if (orignEntity instanceof SysWorkSheet) {
            ((SysWorkSheet) orignEntity)
                .setRecUpdateDate(Timestamp.valueOf(DateUtils.getCurDate()));
            ((SysWorkSheet) orignEntity).setDtimestamp(DateUtils.getNowDate().getTime());
        }

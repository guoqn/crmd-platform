...
import com.ffcs.crmd.platform.mq.listener.impl.ListenerCurrentlyImpl;
import com.ffcs.crmd.platform.mq.util.PropertiesUtil;

public class PushCurrentlyDefined {
    ...
    public void start() throws MqException {
        ...
        IMessageListener messageListener = new ListenerCurrentlyImpl();
